...
const Home = () => {
  ...
  const handleSearch = (event) => {
    ...
    setFilteredMovies(searchedMovies); // Update filtered movies state
  };
  ...
  // Function to filter movies based on genre and showtime
  const filterMovies = () => {
  ...
  return (
    <div className="home">
      ...
      {renderMovies('Now Showing').length > 0 && (
        <h1 className='homeHeader'>Now Showing</h1>
      )}
      <div className="movie-gallery">
        {renderMovies('Now Showing')}
      </div>

      {renderMovies('Coming Soon').length > 0 && (
        <h1 className='homeHeader'>Coming Soon</h1>
      )}
      <div className="movie-gallery">
        {renderMovies('Coming Soon')}
      </div>
    </div>
  );
};
