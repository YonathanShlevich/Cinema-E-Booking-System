...
  let connection;
  try {
    connection = await oracledb.getConnection({ user: "admin", password: "Secondtry123!", connectionString: "(description= (retry_count=20)(retry_delay=3)(address=(protocol=tcps)(port=1522)(host=adb.us-ashburn-1.oraclecloud.com))(connect_data=(service_name=g4972bb3a0743d2_cinemasystems_low.adb.oraclecloud.com))(security=(ssl_server_dn_match=yes)))" });
